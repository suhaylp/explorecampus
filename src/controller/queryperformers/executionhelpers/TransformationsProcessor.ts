...
export function applyAggregations(groups: Map<string, any[]>, applyRules: any[], groupKeys: string[]): any[] {
	const results: any[] = [];
...
export function performTransformations(data: any[], groupKeys: string[], applyRules: any[]): any[] {
